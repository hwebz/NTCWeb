...
namespace Niteco.Search.IndexingService.Configuration
{
	public class IndexingServiceSection : ConfigurationSection
	{
		...
		public int MaxDisplayTextLength
		{
			get
			{
				return (int)base["maxDisplayTextLength"];
			}
			set
			{
				base["maxDisplayTextLength"] = value;
			}
		}
		[ConfigurationProperty("autoUpdateVirtualPath", IsRequired = false, DefaultValue = true), System.Obsolete("AutoUpdateVirtualPath is now decided on a per request basis by checking for an attribute.")]
		public bool AutoUpdateVirtualPath
		{
			get
			{
				return (bool)base["autoUpdateVirtualPath"];
			}
			set
			{
				base["autoUpdateVirtualPath"] = value;
			}
		}
		...
		public int MaxHitsForSearchResults
		{
			get
			{
				return (int)base["maxHitsForSearchResults"];
			}
			set
			{
				base["maxHitsForSearchResults"] = value;
			}
		}
		...
		public int MaxHitsForReferenceSearch
		{
			get
			{
				return (int)base["maxHitsForReferenceSearch"];
			}
			set
			{
				base["maxHitsForReferenceSearch"] = value;
			}
		}
		...
		public ClientCollection Clients
		{
			get
			{
				return (ClientCollection)base["clients"];
			}
		}
		...
		public NamedIndexesElement NamedIndexesElement
		{
			get
			{
				return (NamedIndexesElement)base["namedIndexes"];
			}
			set
			{
				base["namedIndexes"] = value;
			}
		}
	}
}
